...
def example():   
    ...
    col_output = "tmp_test_db_func"

    filter = {"nat_org_src_ip": '10.1.1.1', "name":"B2B GTM"}
...
def test():
    # example()
    # test_clone("discovery_v2", "tmp_test_db_func", "tmp_test_db_func_clone")
    # test_rename("discovery_v2", "correlate_checkpoint_nat_policy", "correlate_checkpoint_nat_policy_backup20231204")
    # test_rename("discovery_v2", "tmp_correlate_checkpoint_nat_policy_fullsize", "tmp_correlate_checkpoint_nat_policy_fullscope")
    pass
